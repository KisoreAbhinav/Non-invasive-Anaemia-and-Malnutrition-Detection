...
function App() {
  ...
  }, [closeCamera, currentTestResult, plan?.visual_cues, stage, startCamera, testIndex]);
              ...
              <div className="camera-controls-bar">
                {activeSlot < subCaps.length ? (
                  <div className="camera-actions">
                    ...
                    <label className="button quiet file-upload-action">
                      Upload image <kbd>U</kbd>
                      <input
                        id="vision-file-input"
                        type="file"
                        accept="image/jpeg,image/png,image/webp"
                        onChange={(event) => handleFileUploadToSlot(activeSlot, event)}
                      />
                    </label>
                    {filled > 0 && (
                      <button
            ...
            <div className="camera-capture">
              {capturedImageUrl ? (
                <div className="captured-preview">
                  <img src={capturedImageUrl} alt={`${test.name} capture`} className="camera-preview-img" />
                  <div className="camera-actions">
                ...
                <div className="camera-viewfinder">
                  ...
                  <div className="camera-actions">
                    ...
                    <button className="button quiet" type="button" onClick={closeCamera}>Stop camera</button>
                  </div>
                </div>
              )}
              <canvas ref={canvasRef} style={{ display: "none" }} />
